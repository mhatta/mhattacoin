...
void RPCNestedTests::rpcNestedTests()
{
    ...
    ClearDatadirCache();
    std::string path = QDir::tempPath().toStdString() + "/" + strprintf("test_mhattacoin_qt_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
    ...
    QVERIFY(result == "800644228908f132970e6ed529af1fc5a05d18f503e7cded8cd8513c19377b99");
