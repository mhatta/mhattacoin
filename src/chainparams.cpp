...
{
    const char* pszTimestamp = "At the Interlink Internship Program in San Jose, Aug. 7, 2018";
    const CScript genesisOutputScript = CScript() << ParseHex("04d7a8d66b712f36d2e864e882fce3333c60e514f568fc8bc860bf622b14d717c188106ab41334d20b54dcbba829191e9ac895ae1b178b534756bc362da7cb8318") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1533662704, 3409472, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x1abd69ab40aa8989b98e03a71569c770e3670c4b529734d790f62344e5df0a9d"));
        assert(genesis.hashMerkleRoot == uint256S("0x800644228908f132970e6ed529af1fc5a05d18f503e7cded8cd8513c19377b99"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.mhattacoin.loshan.co.uk", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("mhattacointools.com", "dnsseed.mhattacointools.com"));
        //vSeeds.push_back(CDNSSeedData("mhattacoinpool.org", "dnsseed.mhattacoinpool.org"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 719751, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x954a12eca8662d6b7cf826aa82915d741dd46a6fec6eb782ebd62d9288038d37"));
        assert(genesis.hashMerkleRoot == uint256S("0x800644228908f132970e6ed529af1fc5a05d18f503e7cded8cd8513c19377b99"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.push_back(CDNSSeedData("mhattacointools.com", "testnet-seed.mhattacointools.com"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.mhattacoin.loshan.co.uk", true));
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x43063d2305db2f230c2cb8d42113bb007fe7644d93c55abc3237bcea8002e36a"));
        assert(genesis.hashMerkleRoot == uint256S("0x800644228908f132970e6ed529af1fc5a05d18f503e7cded8cd8513c19377b99"));
