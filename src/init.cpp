...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/mhattacoin-project/mhattacoin>";
    const std::string URL_WEBSITE = "<https://mhattacoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("MHattaCoin version %s\n", FormatFullVersion());
}
