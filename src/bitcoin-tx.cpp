...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s mhattacoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mhattacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mhattacoin transaction") + "\n" +
              "  mhattacoin-tx [options] -create [commands]   " + _("Create hex-encoded mhattacoin transaction") + "\n" +
              "\n";
